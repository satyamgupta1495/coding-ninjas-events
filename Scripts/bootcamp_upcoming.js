const API_URL =
  "https://api.codingninjas.com/api/v3/events?event_category=BOOTCAMP_EVENT&event_sub_category=Upcoming&tag_list=Interview Preparation, Contest Solutions,  Competitive Programming,  Futuristic Tech,  Coding Concepts,  Career Guidance,  Web Development,  Android,  Machine Learning&offset=0"
...
async function getImage() {
  rand.innerHTML = " "
  //! a href id-> here
  const active = document.querySelector("#boot")
  active.classList.add("active")
  active.style.color = "#F09819"

  //! images id here

  const activetab3 = document.getElementById("boot-active-img")
  activetab3.src = "Images/clickable/bootcamp_events_selected-5398.png"
