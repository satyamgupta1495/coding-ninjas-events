const API_URL =
  "https://api.codingninjas.com/api/v3/events?event_category=WEBINAR&event_sub_category=Upcoming&tag_list=Interview Preparation,Contest Solutions, Competitive Programming, Futuristic Tech,  Coding Concepts,  Career Guidance,  Web Development,  Android,  Machine Learning, Campus Event,  Online Coding Event,  Hackathon,  Women Who Code, GSoC,  Placement, Aptitude Preparation,  Efficient Coding,  Programming Contest,  Coding Marathon,  All Night Coding,  Code Wars,  Scholarship Test&offset=0"
...
async function getImage() {
  rand.innerHTML = " "
  //! a href id-> here
  const active = document.querySelector("#web")
  active.classList.add("active")
  active.style.color = "#F09819"

  //! images id here

  const activetab2 = document.getElementById("web-active-img")
  activetab2.src = "Images/clickable/2.svg"
