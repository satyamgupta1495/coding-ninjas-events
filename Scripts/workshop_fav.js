const API_fav =
  "https://api.codingninjas.com/api/v3/events?event_category=WORKSHOP&event_sub_category=All Time Favorites&tag_list=Interview Preparation, Contest Solutions,  Competitive Programming,  Futuristic Tech,  Coding Concepts,  Career Guidance,  Web Development,  Android,  Machine Learning&offset=0"
...
async function getfavourite() {
  ...
  for (i = 0; i <= x; i++) {
    ...
    while (a < 5) {
      const user =
        json.data.events[i].registered_users.top_users[a].mobile_cover_picture
