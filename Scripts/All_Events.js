...
async function getImage() {
  rand.innerHTML = " "
  //! a href id-> here
  const active = document.querySelector("#events")
  active.classList.add("active")
  active.style.color = "#F09819"

  //! images id here
  const activetab1 = document.getElementById("active-img")
  activetab1.src = "Images/clickable/all-events-selected.svg"
...
const API_arc =
  "https://api.codingninjas.com/api/v3/events?event_category=ALL_EVENTS&event_sub_category=Archived&tag_list=Interview Preparation&offset=0"
...
const API_fav =
  "https://api.codingninjas.com/api/v3/events?event_category=ALL_EVENTS&event_sub_category=All Time Favorites&tag_list=Interview Preparation&offset=0"
...
async function getfavourite() {
  ...
  console.log("gupta  oiuhygfdcfgv")
  rand.innerHTML = " "
  const response = await fetch(
    API_fav +
      new URLSearchParams({
