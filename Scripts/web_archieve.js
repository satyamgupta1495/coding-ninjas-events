const API_arc =
  "https://api.codingninjas.com/api/v3/events?event_category=WEBINAR&event_sub_category=Archived&tag_list=Interview Preparation, Contest Solutions,  Competitive Programming,  Futuristic Tech,  Coding Concepts,  Career Guidance,  Web Development,  Android,  Machine Learning, Campus Event,  Online Coding Event,  Hackathon,  Women Who Code, GSoC,  Placement, Aptitude Preparation,  Efficient Coding,  Programming Contest,  Coding Marathon,  All Night Coding,  Code Wars,  Scholarship Test&offset=0"
